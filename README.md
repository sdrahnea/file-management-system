...
```
nohub java -jar file-management-system-1.0.4.jar --spring.config.location=/app/config/application.properties &
```
...
```
java -jar /projects/app/file-management-system-1.0.4.jar --spring.config.location=/projects/app/config/application.properties
```
